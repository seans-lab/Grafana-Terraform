// A token belongs to an access policy and is used programmatically 
// to identify the entity that requests actions on resources. 
// Authorization is based on rules defined by an access policy and 
// the token presented with a request. 
